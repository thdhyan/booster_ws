...
| 5 | P3 head-track | `Isaac-HeadTrack-K1-v0` | `Isaac-HeadTrack-K1-v0` | 512 (camera + YOLO) | 2000 | physx (`isaac-lab:3.0.0-beta2-post1`) | measured ≈ 42–51 s/iter → ≈ 2.2 h | `logs/rsl_rl/p3_head_track/2026-09-24_14-28-16_p3_head_track/model_1999.pt` | **RUNNING on spark02** (tmux `k1_spark_p3`, started 2026-09-24 14:28 UTC). Zero-step and real-YOLO 16×3 smoke **PASSED**; fixed `(N,3)`→`(N,6)` rigid-body velocity write, isolated Isaac cache, explicit final-iteration marker, and 200-iteration video cadence. WandB [`5e43gwwj`](https://wandb.ai/thakk100-dhyan-home/booster_k1_soccer_hrl/runs/5e43gwwj), log `scripts/p3.full.train.log`. |
