"""Train K1 kick policy with RSL-RL.
...
parser = argparse.ArgumentParser(description="Train K1 kick with RSL-RL.")
parser.add_argument("--video", action="store_true", default=False)
parser.add_argument("--video_length", type=int, default=200)
parser.add_argument("--video_interval", type=int, default=2000)
parser.add_argument("--num_envs", type=int, default=None)
parser.add_argument("--task", type=str, default="Isaac-Kick-Ball-K1-v0")
...
# *** Register K1 velocity and kick tasks ***
import k1_velocity.tasks.velocity  # noqa: F401
import k1_velocity.tasks.kick  # noqa: F401
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg,
    ...
    """Train K1 kick with RSL-RL agent."""
